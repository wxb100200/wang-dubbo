...
//          String formatStr = format(d,C_TIME_PATTON_HHMM);
//          if(new Integer(formatStr.split(":")[0]).intValue()>=12){
//              return format(d,C_TIME_PATTON_hhMM)+" PM";//+pageContext.getAttribute("isPM");
//          }else{
//              return format(d,C_TIME_PATTON_hhMM)+" AM";//+pageContext.getAttribute("isAM");
//          }
        }
    }
